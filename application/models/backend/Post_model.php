...
class Post_model extends CI_Model{
	...
	function get_all_post(){
		$result = $this->db->query("SELECT post_id,post_title,post_image,DATE_FORMAT(post_date,'%d %M %Y') AS post_date,category_name,post_tags,post_status,post_views,user_name FROM tbl_post JOIN tbl_category ON post_category_id=category_id JOIN tbl_user ON user_id=post_user_id");
		return $result;
	}

	function get_role_post($id){
		$result = $this->db->query("SELECT post_id,post_title,post_user_id,post_image,DATE_FORMAT(post_date,'%d %M %Y') AS post_date,category_name,post_tags,post_status, post_views, user_name FROM tbl_post JOIN tbl_category ON post_category_id=category_id JOIN tbl_user ON user_id=post_user_id  WHERE tbl_post.post_user_id='$id'");
		return $result;
	}
